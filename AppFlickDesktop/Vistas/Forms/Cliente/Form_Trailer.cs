...
namespace AppFlickDesktop.Vistas.Forms.Cliente
{
    public partial class Form_Trailer : Form
    {
        ...
        private void cargarVideo()
        {
            ...
            "<iframe width=\"100%\" height=\"336\" src=\"{0}\"" +
            "frameborder = \"0\" allow = \"autoplay; encrypted-media\" allowfullscreen></iframe>" +
            "</body></html>";
            string url = elem_funcion.Funcion.pelicula_url_trailer + "?autoplay=0&modestbranding=1&rel=0&iv_load_policy=3&fs=0&disablekb=1&showinfo=0";
